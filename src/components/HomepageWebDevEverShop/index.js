...
const FeatureList = [
  {
    ...
    description: (
      <>
        React is good, GraphQl makes it better. Use GraphQL query at the
        component level. Data fetching never been easier.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        ...
        start. Stay focused on the code.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        ...
        Edit code and see changes in seconds.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        File-system based middleware. Flexible to add or remove middleware. Easy
  ...
  },
  {
    ...
    description: (
      <>
        Flexible to create API endpoints to provide backend functionality. Easy
        to extend and customize.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Import CSS files from a JavaScript file. Built-in Sass and TailwindCSS
        support. Live reload with HMR.
      </>
    ),
